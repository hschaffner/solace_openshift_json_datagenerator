 ...
 * 
 */
@WebServiceClient(name = "eventInputBundleImplService", targetNamespace = "http://ECS.RBC.COM", wsdlLocation = "file:../XML_Schema/eventInputBundleImpl.wsdl")
    ...
    extends Service
{
    ...
    private final static QName EVENTINPUTBUNDLEIMPLSERVICE_QNAME = new QName("http://ECS.RBC.COM", "eventInputBundleImplService");
    ...
    public EventInputBundleImpl getEventInputBundleImpl() {
        return super.getPort(new QName("http://ECS.RBC.COM", "eventInputBundleImpl"), EventInputBundleImpl.class);
    }
    ...
    public EventInputBundleImpl getEventInputBundleImpl(WebServiceFeature... features) {
        return super.getPort(new QName("http://ECS.RBC.COM", "eventInputBundleImpl"), EventInputBundleImpl.class, features);
    }
